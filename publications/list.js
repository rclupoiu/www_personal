...
const publicationsList = [
    ...
    //A multi-agentic framework for real-time,  autonomous freeform metasurface design
    {
        ...
        journalLink: 'https://www.science.org/doi/10.1126/sciadv.adx8006',
        videoLink: '',
        codeLink: 'https://github.com/jonfanlab/metachat',
        dataLink: 'http://metanet.stanford.edu/search/metachat/',
        websiteLink: '',
        slidesLink: '',
        bibtexData: 
`@article{lupoiu2025multiagentic,
    ...
    //Towards General Neural Surrogate Solvers with Specialized Neural Accelerators
    {
        ...
        journalLink: 'https://openreview.net/forum?id=FNKnLhLuhY',
        videoLink: '',
        codeLink: '',
        dataLink: '',
        websiteLink: '',
